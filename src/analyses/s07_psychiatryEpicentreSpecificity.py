...
def main():
    ...
    print("------------")
    util.save_to_pickle(
        "../../data/results/s07_psychiatricEpicentreSpecificity/psychiatric_epicentre.pkl",
        {"epicentre": epicentre},
    )

    util.save_to_pickle(
        "../../data/results/s07_psychiatricEpicentreSpecificity/psychiatric_association.pkl",
