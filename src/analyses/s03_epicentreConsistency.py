...
def main():
    ...
    atrophy = np.load('../../data/results/s02_atrophyConsistency/atrophy_association.npz',)
    ...
    print('Save results')
    print('------------')
    np.savez('../../data/results/s03_epicentreAssociation/epicentre_association.npz',
